...
Public Class Grocery_Items
    ...
    Private Sub DataGridView1_SelectionChanged(sender As Object, e As EventArgs) Handles DataGridView1.SelectionChanged
        If DataGridView1.SelectedRows.Count > 0 Then
            ...
            ComboBox1.SelectedItem = selectedRow.Cells("Period").Value.ToString()
            TextBox5.Text = selectedRow.Cells("PricePerUnit").Value.ToString()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            ...
            Dim Period As String = ComboBox1.SelectedItem.ToString
    ...
    Private Sub btnFilter_Click(sender As Object, e As EventArgs) Handles btnFilter.Click
        ...
        Dim selectedGrocery As String = If(ComboBox1.SelectedItem IsNot Nothing, ComboBox1.SelectedItem.ToString(), "")
