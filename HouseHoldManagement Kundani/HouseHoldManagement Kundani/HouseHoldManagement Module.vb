...
Module HouseHoldManagment_Module
    ...
    Public Sub FilterMealPlan(Calories As String, StartDate As DateTime)
        Dim conn As New OleDbConnection(HouseHoldManagment_Module.connectionString)
        Dim MealPlans As New DataTable()
        ...
        Try
            ...
            adapter.Fill(MealPlans)
            MealPlan.DataGridView1.DataSource = MealPlans

        Catch ex As Exception
            MsgBox("Error filtering mealplans: " & ex.Message, MsgBoxStyle.Critical, "Database Error")
        Finally
            conn.Close()
        End Try
    End Sub
